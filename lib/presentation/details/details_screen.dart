...
import 'package:movie_app/presentation/details/components/error_widget.dart';
...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  void initState() {
    BlocProvider.of<DetailsBloc>(context)
        .add(DetailsEventStarted(movieId: widget.movieId));
    BlocProvider.of<VideoBloc>(context)
        .add(VideoEventStarted(movieId: widget.movieId));
    super.initState();
  }
      ...
      child: Scaffold(
        body: BlocBuilder<DetailsBloc, DetailsState>(
          builder: (context, state) {
            ...
            return DetailsErrorWidget(errorMessage: state.errorMessage,movieId: widget.movieId,);
            } else if (state is DetailsLoaded) {
              MovieDetails details = state.movieDetails.movieDetails;
              return Body(
